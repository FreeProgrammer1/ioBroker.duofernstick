 ...
 *
 * Version 0.1.21 extends the compact 0.1.20 catalogue with all device type ids
 * from the FHEM-oriented capability list the project is based on. The adapter
 * still treats incoming telegrams as PATCH updates; supported state lists are
 * only used for object creation and do not reset missing values.
 */
