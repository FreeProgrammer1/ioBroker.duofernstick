...
const STICK_COMMANDS = Object.freeze({
    // Compact command templates derived from the public FHEM command names. They are kept in one
...
function buildDeviceCommand(stateKey, value) {
    ...
    if (["position", "targetPosition", "ventilatingPosition", "sunPosition", "slatPosition", "level"].includes(stateKey)) {
        ...
        // DuoFern/FHEM uses inverted shutter position for many devices: ioBroker 0=open, 100=closed.
